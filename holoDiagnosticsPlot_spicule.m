function holoDiagnosticsPlot_spicule(fn, fn_reference)
    %Older version pre-2023, for SPICULE and some older ESCAPE data
    ...
    if isfield(data, 'imagetime')
        ...
        %For update, can subtract datetimes, then use seconds(d) to convert
